...
<module external.linked.project.id=":react-native-gesture-handler" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager">
    ...
    <content url="file://$MODULE_DIR$">
      ...
      <excludeFolder url="file://$MODULE_DIR$/build/intermediates/annotatıons_typedef_fıle" />
      <excludeFolder url="file://$MODULE_DIR$/build/intermediates/annotatıons_zıp" />
      ...
      <excludeFolder url="file://$MODULE_DIR$/build/intermediates/consumer_proguard_fıle" />
